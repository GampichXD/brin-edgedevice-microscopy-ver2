...
CONFIG = {
    ...
    'sift_max_keypoints':  4096,   # keypoints per ROI; -1 = unlimited
...
def build_extractor_matcher(cfg=None):
    """
    Instantiate LightGlue's SIFT extractor and LightGlue matcher.

    LightGlue SIFT produces:
        keypoints       : (N, 2)   pixel coords
        descriptors     : (N, 128) float32  -- 128-dim SIFT
        keypoint_scores : (N,)     DoG response values
    """
    cfg    = cfg or CONFIG
    ...
    print("[INFO] SIFT extractor and LightGlue matcher ready.")
